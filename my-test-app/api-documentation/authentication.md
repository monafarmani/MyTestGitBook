...
**username :** the phone number of the user that used in [Check Identity](authentication.md#api-v1-user-checkidentity) and It is expected to be a string value, e.g. **"+49\_01747707607"**
