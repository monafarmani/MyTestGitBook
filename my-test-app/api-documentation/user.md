...
<mark style="color:red;">**Note:**</mark> Initial is called after the [user's profile data](user.md#profile) &[ user car's data](car.md#car-model) get completed in first-time use.
