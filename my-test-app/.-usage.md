...
The ACCESS\_COARSE\_LOCATION permission poses minimal risk to the user's privacy. However, it is important to note that the user's approximate location data may be collected by your app and used for location-based services. Make sure to handle the user's location data responsibly and in accordance with your app's privacy policy.

**INTERNET**&#x20;

The INTERNET permission is required to send and receive data over the internet. Without this permission, the SDK will not be able to communicate with our servers and will not function properly.

To request the INTERNET permission in your app, add the following line to your app's Manifest file:
